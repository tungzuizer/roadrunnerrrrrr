...
@Autonomous(name = "TUDONGCLIP")
public class TUDONGCLIP extends LinearOpMode {
    public class Lift {
        ...
        public class Keonew implements Action {
            ...
            public boolean run(@NonNull TelemetryPacket packet) {
                ...
                linerLeft.setTargetPosition(1085);
                linerRight.setTargetPosition(1085);
        ...
        public class Keolennew implements Action {
            @Override
            public boolean run(@NonNull TelemetryPacket packet) {
        ...
        public Action keolennew() {
            return new Keolennew();
        }
        public class Keohanew implements Action {
            @Override
            public boolean run(@NonNull TelemetryPacket packet) {

                linerLeft.setTargetPosition(0);
                linerRight.setTargetPosition(0);
                linerLeft.setPower(1);
                linerRight.setPower(1);
                linerLeft.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                linerRight.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    ...
    public void runOpMode() {
        ...
        drivetrain.updatePoseEstimate();
        Actions.runBlocking(drivetrain.actionBuilder(drivetrain.pose)
                .strafeToLinearHeading(new Vector2d(9,30),Math.toRadians(270))

                .build());
        Actions.runBlocking(nang.nangUp());

        Actions.runBlocking(lift.keolennew());
       // Actions.runBlocking(claw.choClaw());

        Actions.runBlocking(claw.openClaw());
    //    Actions.runBlocking(claw.choClaw());

        Actions.runBlocking(lift.keohanew());
        ////////////////////////////////////////////////////////////////////////////////////////////////////
